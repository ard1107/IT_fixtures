...
@Address_blueprint.route('/adderss/<int:id>' , methods=["GET"])
def get_address_id(id):
    address = Address.query.filter_by(id=id).first()
    return jsonify(address.to_dict_add())

@Address_blueprint.route('/update_address', methods=["PUT"])
...
@Address_blueprint.route('/delete_address' ,methods=["DELETE"])
